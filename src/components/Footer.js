  ...
  const captureSocialMediaEvent = (socialMediaSite) => {
    ...
    return (
        <div className="container-fluid bg-dark text-light footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s" style={{textAlign: 'center'}}>
                        {/* <span className="h4 section-title ff-secondary text-start text-warning fw-normal mb-4 d-block">Contact</span> */}
                ...
                <br/>
                    <div className="row">
                        <div className="col-12 text-center mb-3 mb-md-0">
                             <p>&copy; 2026 Kuya Kevin's BBQ, All Rights Reserved.</p>
