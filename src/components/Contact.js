          ...
          <div className="col-12">
            <div className="row gy-4">
              <div className="col-md-4">
                <h5 className="section-title ff-secondary fw-normal text-start text-warning">Booking</h5>
                <p><i className="fa fa-envelope-open text-warning me-2"></i>book@example.com</p>
              </div>
              <div className="col-md-4">
                <h5 className="section-title ff-secondary fw-normal text-start text-warning">General</h5>
                <p><i className="fa fa-envelope-open text-warning me-2"></i>info@example.com</p>
              </div>
              <div className="col-md-4">
